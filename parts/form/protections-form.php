                                    ...
                                    <div class="form-one form-step active">
                                        ...
                                        <div class="grid-x grid-padding-x align-center-middle mortgage-type">
                                            <fieldset class="medium-12 cell text-center justify-content-center align-center">
                                                <legend><h2 class="margin-bottom-2">Select Protection Type</h2></legend>

                                              <div class="radio-row">
                                                <div class="radio-column">
                                                  <div>
                                                    <input type="radio" name="protection-option" value="life-insurance" id="life-insurance" required><label for="life-insurance">
                                                  ...
                                                  <div>
                                                    <input type="radio" name="protection-option" value="critical-illness-cover" id="critical-illness-cover">
                                                    <label for="critical-illness-cover">
                                                      <div class="ins-ft-scroll-icon">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/scroll/ic1.svg" alt="">
                                                      </div>
                                                  ...
                                                  <div>
                                                    <input type="radio" name="protection-option" value="le-critical-cover" id="le-critical-cover">
                                                    <label for="le-critical-cover">
                                                      <div class="ins-ft-scroll-icon">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/scroll/ic9.svg" alt="">
                                                      </div>
                                                ...
                                                <div class="radio-column">
                                                  <div>
                                                    <input type="radio" name="protection-option" value="mortgage-protection" id="mortgage-protection">
                                                  ...
                                                  <div>
                                                    <input type="radio" name="protection-option" value="income-protection" id="income-protection">
                                                    <label for="income-protection">
                                                      <div class="ins-ft-scroll-icon">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/scroll/ic3.svg" alt="">
                                                      </div>
                                                  ...
                                                  <div>
                                                    <input type="radio" name="protection-option" value="whole-of-life" id="whole-of-life">
                                        ...
                                        <div class="cell medium-12">
                                            ...
                                            <div class="grid-x">
                                                <div class="small-4 cell">
                                                    <label for="cover-amount" class="text-left middle">Cover Amount</label>
                                                </div>
                                                <div class="small-7 small-offset-1 cell">
                                                    <div class="input-group">
                                                        <span class="input-group-label">£</span>
                                                        <input class="input-group-field" id="cover-amount" type="number" required pattern="number"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="grid-x">
                                                <div class="small-4 cell">
                                                    <label for="cover-term" class="text-left middle">Term of Cover</label>
                                                </div>
                                                <div class="small-7 small-offset-1 cell">
                                                    <div class="input-group">
                                                        <input class="input-group-field" id="cover-term" type="number" required pattern="number"/>
